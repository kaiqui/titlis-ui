...
Nos findings remediáveis, **Corrigir com ConfiaAI** abre o fluxo de remediação (PR unitário, com
aprovação humana). Veja ConfiaAI. O destino do PR vem do `gitops.paths` do
`service.yaml`.
