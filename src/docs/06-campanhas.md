...
Para correções pontuais em um único workload, use o ConfiaAI diretamente.
...
### A partir de findings de scorecard (via ConfiaAI)

Você pode pedir ao ConfiaAI para criar uma campanha baseada em findings:

> *"Crie uma campanha para adicionar liveness probe em todos os workloads do namespace payments"*

O ConfiaAI lista os workloads afetados, exibe um resumo da mudança e aguarda sua confirmação
antes de iniciar.
...
Assim como no ConfiaAI, campanhas nunca geram PRs que reduzam recursos:
