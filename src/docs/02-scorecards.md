...
- Botões de ação (explicar finding com ConfAI, corrigir com ConfAI)
...
### Via ConfAI
Clique em **Corrigir com IA** no finding. A ConfAI propõe um patch unitário e, após sua
confirmação, abre um PR de correção. Veja mais em ConfAI.
