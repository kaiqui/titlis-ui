...
interface SelectionListItem {
  ...
  // action renders OUTSIDE the button wrapper to avoid nested-button (invalid HTML)
        ...
        return (
          <div key={item.id} className="relative">
            <button
              ...
              className={cn('w-full rounded-[1.4rem] border px-4 py-4 text-left transition-colors', item.action && 'pr-10')}
              style={{
