...
export function PageLoading() {
  return (
    <div className="flex min-h-[60vh] flex-1 items-center justify-center px-6">
      <motion.div
        className="flex flex-col items-center gap-4 rounded-[14px] border-2 px-10 py-10 text-center"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
...
export function PageError({ message, onRetry }: PageErrorProps) {
  return (
    <div className="flex min-h-[60vh] flex-1 items-center justify-center px-6">
      <motion.div
        className="flex max-w-md flex-col items-center gap-4 rounded-[14px] border-2 px-8 py-10 text-center"
