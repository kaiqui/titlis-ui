...
ARG VITE_OKTA_POST_LOGOUT_REDIRECT_URI=
ARG VITE_OKTA_TENANT_SLUG=
ARG VITE_DEV_TENANT_ID=1
ARG VITE_DEV_TENANT_SLUG=titlis
ARG VITE_DEV_TENANT_NAME=Titlis
ARG VITE_DEV_USER_EMAIL=dev@titlis.local
ARG VITE_DEV_USER_NAME=Dev User
ARG VITE_DEV_ROLES=titlis.admin
ARG VITE_FEATURE_AI=true
ARG VITE_FEATURE_SLOS=true
ARG VITE_FEATURE_QUEUES=true
...
ENV VITE_FEATURE_SLOS=$VITE_FEATURE_SLOS
ENV VITE_FEATURE_QUEUES=$VITE_FEATURE_QUEUES
